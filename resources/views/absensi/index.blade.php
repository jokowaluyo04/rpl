                    ...
                    <table class="min-w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-left">
                                ...
                                <th class="py-3 px-4 text-sm font-medium text-gray-600">Keterangan</th>
                        ...
                        <tbody>
                            @foreach ($absensis as $absensi)
                                <tr class="border-b hover:bg-gray-50">
                                    <td class="py-3 px-4 text-sm text-gray-800">{{ $absensi->tanggal }}</td>
                                    <td class="py-3 px-4 text-sm text-gray-800">{{ $absensi->siswa->user->name }}</td>
                                    <td class="py-3 px-4 text-sm text-gray-800">{{ $absensi->kelas }}</td>
                                    <td class="py-3 px-4 text-sm text-gray-800">{{ $absensi->status }}</td>
                                    <td class="py-3 px-4 text-sm text-gray-800">{{ $absensi->keterangan }}</td>
