<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            ...
            <i class="fa-solid fa-angle-right mx-2"></i>Edit Laporan Perkembangan
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <!-- Form -->
                <form action="{{ route('laporan_perkembangan.update', $laporanPerkembangan->id) }}" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="tanggal" value="{{ $laporanPerkembangan->tanggal }}"
                    ...
                    <div class="mb-4">
                        ...
                        <select name="siswa_id" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg"
                            ...
                            @foreach ($siswas as $siswa)
                                <option value="{{ $siswa->id }}" @if ($siswa->id == $laporanPerkembangan->siswa_id) selected @endif>
                                    {{ $siswa->user->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="deskripsi" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg" required>{{ $laporanPerkembangan->deskripsi }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="nilai_matematika"
                            value="{{ $laporanPerkembangan->nilai_matematika }}"
                            class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="nilai_ipa" value="{{ $laporanPerkembangan->nilai_ipa }}"
                            class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="nilai_ppkn" value="{{ $laporanPerkembangan->nilai_ppkn }}"
                            class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="nilai_bahasa_indonesia"
                            value="{{ $laporanPerkembangan->nilai_bahasa_indonesia }}"
                            class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="jumlah_hadir" value="{{ $laporanPerkembangan->jumlah_hadir }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="jumlah_tidak_hadir"
                            value="{{ $laporanPerkembangan->jumlah_tidak_hadir }}"
                            class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="catatan" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg">{{ $laporanPerkembangan->catatan }}</textarea>
                    </div>
